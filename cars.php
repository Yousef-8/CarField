...
<link rel="stylesheet" type="text/css" href="cars2.css">
...
<body>
    ...
    <div class="car-container">
        ...
        $connection = mysqli_connect("localhost", "root", "MySQL2025.", "carfield_database");
        ...
        if (mysqli_num_rows($result) > 0) {
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<img src="uploads/' . $row["car_image"] . '" alt="' . $row["car_model"] . '" class="car-image" onclick="openCarDetails(' . $row["car_id"] . ')">';
    ...
    <?php
    // Function to get distinct options 
