...
<head>
    <title>Welcome</title>
    <link rel="stylesheet" type="text/css" href="upload_posts.css">
</head>
<body>
...
<header>
   ...
   <div class="title">   <strong> title: <input type="text" name="title" required class="title-box" ><br><br>  </strong> </div>
    ...
    <div class="image">   <strong> Image: <input type="file" name="image"  accept="image/jpg, image/jpeg, image/png, image/webp">  </strong> </div>   
