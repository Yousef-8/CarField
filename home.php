...
// Now, we can use the same connection for the next query
?>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="sidebar">
            ...
            <div class="latest-posts">
                ...
                $latestResult = $connection->query($latestSql);
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.dot').click(function () {
                var dotIndex = $(this).index(); //dot of that index(post-id)
                showPost(dotIndex); //show the post of that index
            });

            $('.post').click(function () {
                var postId = $(this).data('post-id'); //post-d of that specific post
